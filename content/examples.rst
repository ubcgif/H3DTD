...
Here, the program libraries for H3DTD v2 will be used to forward model and invert TEM data in the case of galvanic sources. In this tutorial, we learn to:
